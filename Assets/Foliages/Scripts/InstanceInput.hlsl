...
int _TangentOffset;
int _UVOffset;
int _StaticLightmapUVOffset; // TEXCOORD1 aka Mesh.uv2
...
float2 LoadStaticLightmapUV(uint index) {
    return asfloat(_Vertices.Load2(index * _Stride + _StaticLightmapUVOffset));
}
